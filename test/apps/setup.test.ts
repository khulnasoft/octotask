...
describe("Setup app", () => {
  ...
  beforeEach(async () => {
    ...
    server = new Server({
      Octotask: Octotask.defaults({
        ...
        // workaround for https://github.com/octotask/octotask/issues/1512
        appId: 1,
  ...
  describe("logs", () => {
    it("should log welcome message", () => {
      const expMsgs = [
        "",
        "Welcome to Octotask!",
        "Octotask is in setup mode, webhooks cannot be received and",
  ...
  describe("GET /octotask", () => {
    it("returns a 200 response", async () => {
      await request(server.expressApp).get("/octotask").expect(200);
    });
  });

  describe("GET /octotask/setup", () => {
