...
import type { OctotaskOctokit } from "./octokit/octotask-octokit.js";
...
export class Context<Event extends WebhookEvents = WebhookEvents> {
  ...
  public octokit: OctotaskOctokit;
  public log: Logger;
   ...
   * you can `context.octokit.config.get(options)`, see https://github.com/octotask/octokit-plugin-config.
   *
