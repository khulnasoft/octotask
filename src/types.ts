...
// See https://github.com/octotask/octotask/issues/1388
// See https://github.com/octotask/octotask/issues/1815 as for why this is in a seperate type, and not directly passed to `Webhooks`
type SimplifiedObject = Omit<Context, keyof WebhookEvent>;
export type OctotaskWebhooks = Webhooks<SimplifiedObject>;
...
export type OctokitOptions = NonNullable<
  ConstructorParameters<typeof OctotaskOctokit>[0]
>;
