...
const { createOctotask } = require('../lib/create-octotask');
...
const middleware = createNodeMiddleware(appFn, { octotask: createOctotask() });

const server = createServer(middleware);

server.listen(3000, async () => {
  console.log("Octotask started http://localhost:3000/")
